...
urlpatterns = [
    ...
    # Class_Registration
    path("class_registrations/students/<student_id>", views.ClassRegistrationListView.as_view()),
    ...
    # Test_Result
    path("test_results/students/<student_id>", views.TestResultListView.as_view()),
    ...
    # Attendance
    path("attendance/students/<student_id>", views.AttendanceListView.as_view()),
