"""
Django settings for _mgt_school project.
...
ALLOWED_HOSTS = ["web-production-1b55.up.railway.app", "0.0.0.0"]
...
WSGI_APPLICATION = "_mgt_school.wsgi.application"
